...
<html>
    <head>
        ...
        <title>Nuevo Préstamo Institucional</title>
...
<jsp:include page='inc/menu_administradora.jsp' />
            ...
            <div class="container">
                ...
                <h2 class="form-signin-heading">Nuevo Préstamo</h2>
                 <form class="form-signin" role="form" method="post" action="prestamo.jsp">
                <div class="panel panel-primary">
                        <div class="panel-heading">Ingrese Datos del Préstamo</div>
                ...
                <div class="row">
                     ...
                     <div class="col-xs-4">  
                         ...
                         Código Empleado:<input  type="text" name="empcodigo" value="<%= empleado.getEmpCodigo() %>" class="form-control input-sm"  required readonly/>
                        ...
                        Cuota Mensual: <br>
                                    <div class="input-group">
                                        ...
                                        <input type="number" name="cuotaMensual"  class="form-control input-sm" required min="0.00" max="200.00"><br>
                                    </div><br>
                           </div>
                    <div class="col-xs-4">  
                        Nombre:<input  type="text" name="nombre" value="<%= empleado.getEmpNombre() %>" class="form-control input-sm"  required readonly/>
                       
                        Número de cuotas:<input  type="number" name="numeroCuotas"  class="form-control input-sm"  required min="0"/> 
                        Monto: <br>
                                    <div class="input-group">
                                        <span class="input-group-addon input-sm">$</span>
                                        <input type="number" name="monto"  class="form-control input-sm" required min="0.00" max="200.00"><br>
                                    </div><br>
