...
<%
    ...
    if (request.getParameter("a1") != null) {
        ...
        try {
            ...
            String rutaParcial = "documentos/evaluaciones/ev_competencias-"+ request.getParameter("codigo") + "-" + new SimpleDateFormat("ddMMyyHHmmss").format(new Date()) + ".pdf";
            rutaCompleta += rutaParcial;
            JasperExportManager.exportReportToPdfFile(jasperPrint, rutaCompleta);
            CtrlCEFAS_EvaluacionPorCompetencias ctrlEvaluacionCompetencias = new CtrlCEFAS_EvaluacionPorCompetencias();
            ctrlEvaluacionCompetencias.guardar(request.getParameter("codigo"), new Date(), rutaParcial);
          ...
          destino.add(emp);
          ctrlAviso.guardar(new Date(), "Usted ha recibido una nueva evaluación por competencias. Dirijase a su perfil para verlo", destino , "Sistema de Recursos Humanos - CEFAS");
...
<html>
    <head>
        ...
        <title>Evaluación por Competencias</title>
    ...
    <body>
        <div id="container">
            ...
            <div class="container">
                ...
                <%= mensaje %>
                <form class="form-signin" role="form" method="post" action="evaluacionCompetencias.jsp">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="e1" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="e2" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="e3" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="e4" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="e5" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="f1" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="f2" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="f3" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="f4" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="f5" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="g1" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="g2" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="g3" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="g4" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="g5" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="h1" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="h2" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="h3" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="h4" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="h5" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="i1" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="i2" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="i3" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="i4" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="i5" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="j1" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="j2" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="j3" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="j4" value="1" required> </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="j5" value="1" required> </td>
